...
install::yq() {
    ...
    log::status "Installing mikefarah/yq"
    GOBIN="${LOCALBIN_OS_ARCH}" golang::install github.com/mikefarah/yq/v4 latest
}
...
install::yamlfmt() {
    ...
    GOBIN="${LOCALBIN_OS_ARCH}" golang::install github.com/google/yamlfmt/cmd/yamlfmt latest
}
