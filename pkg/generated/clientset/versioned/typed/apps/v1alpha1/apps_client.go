...
import (
	...
	"kusionstack.io/kube-api/pkg/generated/clientset/versioned/scheme"
)
...
// AppsV1alpha1Client is used to interact with features provided by the apps.kusionstack.io group.
...
func (c *AppsV1alpha1Client) OperationJobs(namespace string) OperationJobInterface {
	return newOperationJobs(c, namespace)
}
...
func (c *AppsV1alpha1Client) PodTransitionRules(namespace string) PodTransitionRuleInterface {
	return newPodTransitionRules(c, namespace)
}

func (c *AppsV1alpha1Client) ResourceContexts(namespace string) ResourceContextInterface {
	return newResourceContexts(c, namespace)
}
