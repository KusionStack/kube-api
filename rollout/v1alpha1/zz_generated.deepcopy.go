...
func (in *BatchStrategyV2) DeepCopyInto(out *BatchStrategyV2) {
	*out = *in
	if in.Batches != nil {
		in, out := &in.Batches, &out.Batches
		*out = make([]RolloutBatchStep, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CanaryStrategyV2) DeepCopyInto(out *CanaryStrategyV2) {
	*out = *in
	if in.Targets != nil {
		...
		*out = make([]RolloutTargets, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RolloutBatchStep) DeepCopyInto(out *RolloutBatchStep) {
	*out = *in
	if in.Targets != nil {
		in, out := &in.Targets, &out.Targets
		*out = make([]RolloutTargets, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RolloutBatchStep.
func (in *RolloutBatchStep) DeepCopy() *RolloutBatchStep {
	if in == nil {
		return nil
	}
	out := new(RolloutBatchStep)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RolloutTargets) DeepCopyInto(out *RolloutTargets) {
	*out = *in
	out.Replicas = in.Replicas
	if in.ReplicaSlidingWindow != nil {
		in, out := &in.ReplicaSlidingWindow, &out.ReplicaSlidingWindow
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RolloutTargets.
func (in *RolloutTargets) DeepCopy() *RolloutTargets {
	if in == nil {
		return nil
	}
	out := new(RolloutTargets)
	in.DeepCopyInto(out)
	return out
}
