...
func (in *BackendRoutingStatus) DeepCopyInto(out *BackendRoutingStatus) {
	*out = *in
	...
	if in.Forworading != nil {
		in, out := &in.Forworading, &out.Forworading
		*out = new(ForwardingStatuses)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ForwardingStatuses) DeepCopyInto(out *ForwardingStatuses) {
	*out = *in
	if in.Origin != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForwardingStatuses.
func (in *ForwardingStatuses) DeepCopy() *ForwardingStatuses {
	if in == nil {
		return nil
	}
	out := new(ForwardingStatuses)
