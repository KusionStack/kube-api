...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BaseHTTPRouteRule) DeepCopyInto(out *BaseHTTPRouteRule) {
	*out = *in
	if in.Matches != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BaseHTTPRouteRule.
func (in *BaseHTTPRouteRule) DeepCopy() *BaseHTTPRouteRule {
	if in == nil {
		return nil
	}
	out := new(BaseHTTPRouteRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HTTPRouteRule) DeepCopyInto(out *HTTPRouteRule) {
	*out = *in
	in.BaseHTTPRouteRule.DeepCopyInto(&out.BaseHTTPRouteRule)
	if in.Weight != nil {
